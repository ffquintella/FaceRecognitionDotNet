...
{
    public class FaceRecognitionModelV2: IFaceRecognitionModel
    {
        public Matrix<double> ComputeFaceDescriptor(LossMetric net, Image img, FullObjectDetection face, int numJitters)
        {
            var faces = new[] { face };
            return ComputeFaceDescriptors(net, img, faces, numJitters).First();
        }

        public IEnumerable<Matrix<double>> ComputeFaceDescriptors(LossMetric net, Image img, IEnumerable<FullObjectDetection> faces, int numJitters)
        {
        ...
        public IEnumerable<IEnumerable<Matrix<double>>> BatchComputeFaceDescriptors(LossMetric net, IList<Image> batchImages, IList<IEnumerable<FullObjectDetection>> batchFaces, int numJitters)
        {
